...
window.onload = function () {
    ...
    function displayData() {
        ...
        objectStore.openCursor().onsuccess = function (event) {
            ...
            if (cursor) {
                ...
                SendButton.setAttribute('data-task', cursor.value.taskTitle);
                SendButton.onclick = function (event) {
                    sendMessageToDo(event);
                }
    ...
    function sendMessageToDo(event) {
        let dataTask = event.target.getAttribute('data-task');
        console.log('Client sending message: ', dataTask);
        socket.emit('message', dataTask);
    }
